 ...
 * @returns
 */
export declare const isParentToChildTransactionRequest: <T>(possibleRequest: IsNotTransactionRequest<T> | ParentToChildTransactionRequest) => possibleRequest is ParentToChildTransactionRequest;
/**
 * Check if an object is of ChildToParentTransactionRequest type
 * @param possibleRequest
 * @returns
 */
export declare const isChildToParentTransactionRequest: <T>(possibleRequest: IsNotTransactionRequest<T> | ChildToParentTransactionRequest) => possibleRequest is ChildToParentTransactionRequest;
export {};

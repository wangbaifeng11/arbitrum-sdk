...
exports.resetNetworksToDefault = exports.getChildrenForNetwork = exports.isParentNetwork = void 0;
...
exports.isArbitrumNetworkNativeTokenEther = isArbitrumNetworkNativeTokenEther;
/*
...
const IERC20Bridge__factory_1 = require("../abi/factories/IERC20Bridge__factory");
...
async function getNativeToken(bridge, provider) {
    try {
        return await IERC20Bridge__factory_1.IERC20Bridge__factory.connect(bridge, provider).nativeToken();
    }
    catch (err) {
...
function isArbitrumNetworkNativeTokenEther(network) {
    return (typeof network.nativeToken === 'undefined' ||
        network.nativeToken === ethers_1.constants.AddressZero);
}
